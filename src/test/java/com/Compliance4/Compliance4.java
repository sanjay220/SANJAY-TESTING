...
public class Compliance4 extends BaseClass{
	@Given("^user on home page in application$")
    public void user_on_home_page_in_application() throws Throwable {
		//delete hold policy and delete group level search before automating
		login();
		Thread.sleep(3000);
    ...
    public void user_lands_on_home_page_and_click_on_created_app_and_clicks_on_group_level_search() throws Throwable {
    ...
    public void user_enter_search_field() throws Throwable {
    	driver.findElement(By.xpath("//span[contains(text(),'Search')]")).click();
		Thread.sleep(7000);
    }

    @Then("^apply hold for group level$")
    public void apply_hold_for_group_level() throws Throwable {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//input[@formcontrolname='holdName']")).sendKeys("hold new11");
		Thread.sleep(3000);
		driver.findElement(By.xpath("//mat-select[@formcontrolname='holdType']")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("//mat-select[@formcontrolname='holdType']")).click();
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//span[contains(text(),'hold new11')]")).click();
		Thread.sleep(3000);
    ...
    public void user_login_app_and_go_to_system_settings() throws Throwable {
    	login();
    ...
    public void user_click_on_job_button_in_application() throws Throwable {
    	driver.findElement(By.xpath("//mat-icon[contains(text(),'schedule')]")).click();
    	Thread.sleep(3000);
    ...
    public void user_start_adding_a_group_hold_via_table_job_by_clicking_add_icon() throws Throwable {
    	driver.findElement(By.xpath("//input[@formcontrolname='jobName']")).sendKeys("group hold1");
    	Thread.sleep(3000);
    ...
    public void user_creates_a_group_hold_job_and_navigate_to_job_page() throws Throwable {
    	driver.findElement(By.xpath("//span[contains(text(),'Create')]")).click();
    	Thread.sleep(7000);
    ...
    public void user_logins_the_application_and_navigate_to_system_settings() throws Throwable {
    	login();
    ...
    public void user_select_job_tab_to_create_a_group_hold() throws Throwable {
    	driver.findElement(By.xpath("//mat-icon[contains(text(),'schedule')]")).click();
    	Thread.sleep(3000);
    ...
    public void user_start_adding_a_group_hold_via_search_job_by_clicking_add_icon() throws Throwable {
    	driver.findElement(By.xpath("//input[@formcontrolname='jobName']")).sendKeys("group hold2");
    	Thread.sleep(3000);
    	driver.findElement(By.xpath("//mat-select[@formcontrolname='jobDefinitionId']")).click();
    	driver.findElement(By.xpath("//mat-select[@formcontrolname='jobDefinitionId']")).click();
    	Thread.sleep(3000);
    ...
    public void user_click_on_creates_group_hold_via_search_and_navigate_to_job_page_in_application() throws Throwable {
    	driver.findElement(By.xpath("//span[contains(text(),'Create')]")).click();
		Thread.sleep(7000);
		driver.findElement(By.xpath("//header/mat-toolbar[1]/div[1]/div[2]/button[3]/span[1]/mat-icon[1]")).click();
		Thread.sleep(3000);
